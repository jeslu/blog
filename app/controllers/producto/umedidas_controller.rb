class Producto::UmedidasController < ApplicationController
  before_action :set_producto_umedida, only: %i[ show edit update destroy ]

  # GET /producto/umedidas or /producto/umedidas.json
  def index
    @producto_umedidas = Producto::Umedida.all
  end

  # GET /producto/umedidas/1 or /producto/umedidas/1.json
  def show
  end
  ...
  # POST /producto/umedidas or /producto/umedidas.json
  def create
  ...
  # PATCH/PUT /producto/umedidas/1 or /producto/umedidas/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /producto/umedidas/1 or /producto/umedidas/1.json
  def destroy
