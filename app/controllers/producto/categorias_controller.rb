class Producto::CategoriasController < ApplicationController
  before_action :set_producto_categoria, only: %i[ show edit update destroy ]

  # GET /producto/categorias or /producto/categorias.json
  def index
    @producto_categorias = Producto::Categoria.all
  end

  # GET /producto/categorias/1 or /producto/categorias/1.json
  def show
  end
  ...
  # POST /producto/categorias or /producto/categorias.json
  def create
  ...
  # PATCH/PUT /producto/categorias/1 or /producto/categorias/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /producto/categorias/1 or /producto/categorias/1.json
  def destroy
