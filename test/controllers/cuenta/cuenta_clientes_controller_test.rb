...
class Cuenta::CuentaClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuenta_cuenta_cliente" do
    assert_difference('Cuenta::CuentaCliente.count') do
      post cuenta_cuenta_clientes_url, params: { cuenta_cuenta_cliente: { activo: @cuenta_cuenta_cliente.activo, cliente_id: @cuenta_cuenta_cliente.cliente_id, fecha: @cuenta_cuenta_cliente.fecha, user_id: @cuenta_cuenta_cliente.user_id } }
    end
  ...
  test "should update cuenta_cuenta_cliente" do
    patch cuenta_cuenta_cliente_url(@cuenta_cuenta_cliente), params: { cuenta_cuenta_cliente: { activo: @cuenta_cuenta_cliente.activo, cliente_id: @cuenta_cuenta_cliente.cliente_id, fecha: @cuenta_cuenta_cliente.fecha, user_id: @cuenta_cuenta_cliente.user_id } }
